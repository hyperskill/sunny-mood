...
public class D3_PlatformTest
{
    ...
    public IEnumerator NecessaryComponents()
    {
        ...
        foreach (GameObject platform in platforms)
        {
            ...
            {
                Assert.Fail("Level 3: Platforms should be children of \"Grid\" object, because tilemap should be a child of grid");
            }
            ...
            if (!platformTMR)
                Assert.Fail("Level 3: There should be a <TilemapRenderer> component on \"Platform\"s' object to view created tilemaps");
            ...
            {
                Assert.Fail("Level 3: \"Platform\"s' <Collider2D> component should have assigned <2D Physics Material> with " +
            ...
            {
                Assert.Fail("Level 3: Let \"Platform\"s' <Collider2D> component be at least twice as wider, than player's one");
            }
        }
    }
    [UnityTest, Order(2)]
